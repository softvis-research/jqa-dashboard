...
describe('<Dashboard />', () => {
    ...
    it('should render without throwing an error', () => {
        ...
        expect(html).to.contain('<strong>Architecture metrics</strong>');
        expect(html).to.contain('<strong>Relation metrics</strong>');
        expect(html).to.contain('<strong>Activity metrics</strong>');
        expect(html).to.contain('<strong>PMD</strong>');
    });
