const routes = {
    ...
    '/resource-management/knowledge-distribution': 'Knowledge Distribution',
    ...
    '/quality-management/static-code-analysis': 'Static Code Analysis',
    '/quality-management/static-code-analysis/pmd': 'PMD',
