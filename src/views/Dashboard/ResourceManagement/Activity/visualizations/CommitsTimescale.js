...
class CommitsTimescale extends DashboardAbstract {
    ...
    render() {
        ...
        var colors = ["#c6e48b", "#7bc96f", "#239a3b", "#192127"];
        ...
        return (
            <div className="calendar-wrapper visualization-wrapper">
                <DateRangePicker
                    ...
                    onApply={function(event, picker) {
                        ...
                        AppDispatcher.handleAction({
                            ...
                            data: {
                                displayFrom: startDate.toLocaleDateString(
                                    "sv-SE",
                                    options
                                ), //sweden uses iso-format =)
                                displayTo: endDate.toLocaleDateString(
                                    "sv-SE",
                                    options
                                )
                            }
                ...
                >
                    <div
                        id="daterange"
                        className="selectbox pull-right float-right"
                    >
                        <i className="fa fa-calendar" />
                        <span>
                            {dateFormat(this.state.displayFrom, "dS mmmm yyyy")}{" "}
                            - {dateFormat(this.state.displayTo, "dS mmmm yyyy")}
                        </span>{" "}
                        <b className="caret" />
                    </div>
                </DateRangePicker>
